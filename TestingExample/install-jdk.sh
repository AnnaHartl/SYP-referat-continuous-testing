...
# download temurin 17
JDK_URL="http://edufs.edu.htl-leonding.ac.at/~t.stuetz/download/nvs/jdk/OpenJDK17U-jdk_x64_linux_hotspot_17.0.4.1_1.tar.gz"
...
# download jdk
curl -L -O ${JDK_URL}
tar xzvf OpenJDK17U-jdk_x64_linux_hotspot_17.0.4.1_1.tar.gz
mv jdk-17.0.4.1+1 ${JAVADIR}
